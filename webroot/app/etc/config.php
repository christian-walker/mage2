...
return [
    'modules' => [
        ...
        'Mage2tv_Js' => 1,
        'Temando_Shipping' => 1,
        'TrainingJsUnit2_SkeletonDataMageInit' => 1,
        'TrainingJsUnit2_SkeletonSimpleProductXInit' => 1,
        'Vertex_Tax' => 1,
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'connector_dynamic_content' => [
                ...
                'external_dynamic_content_urls' => [
                    'passcode' => 'RtD6cnSWXBQ3CpqCavpHrGKCzLpBDVvH',
            ...
            'msp_securitysuite_twofactorauth' => [
                ...
                'duo' => [
                    'application_key' => 'jtIXdGOhNjdynJJkOyDHQw1F642tpKgCtM2l1cnHAqctbn7rcSWl4s7izIL09sJ1',
                ],
            ],
            ...
            'yotpo' => [
                ...
                'sync_settings' => [
                    ...
                    'orders_sync_start_date' => '2020-04-15',
                ],
                'module_info' => [
                    'yotpo_installation_date' => '2020-04-15',
                ],
            ],
        ],
        'stores' => [
